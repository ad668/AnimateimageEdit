...
class EditBar(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.new_button = Button(self, text="New", **button_style)
        self.save_button = Button(self, text="Save", **button_style)
        self.save_as_button = Button(self, text="Save As", **button_style)
        self.draw_button = Button(self, text="Draw", **button_style)
        self.crop_button = Button(self, text="Crop", **button_style)
        self.mirror_button = Button(self, text="Mirror", **button_style)
        self.rotate_button = Button(self, text="Rotate", **button_style)
        self.filter_button = Button(self, text="Filter", **button_style)
        self.adjust_button = Button(self, text="Adjust", **button_style)
        self.clear_button = Button(self, text="Clear", **button_style)
